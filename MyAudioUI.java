	...
	public static void main(String[] args) {
		...
		while (scanner.hasNextLine()) {
			...
			// see class Library for the method to call
				...
				int index = 0;
				System.out.print("Content No.:");
				if (scanner.hasNextInt()) {
					index = scanner.nextInt();
					scanner.nextLine(); // "consume" nl character (necessary when mixing nextLine() and nextInt())
				}
				if (!mylibrary.playPlaylist(playlistTitle, index)) {
					System.out.println(mylibrary.getErrorMessage());
				}
			...
			// see class Library for the method to call
				...
				if (scanner.hasNextInt()) {
					index = scanner.nextInt();
					// scanner.nextLine(); // "consume" nl character (necessary when mixing
			...
			// see class Library for the method to call
				...
				mylibrary.addContentToPlaylist(type, librarycontent, playlistTitle);
			...
			// see class Library for the method to call
				...
				if (scanner.hasNextInt()) {
					playindex = scanner.nextInt();
					scanner.nextLine(); // "consume" nl character (necessary when mixing nextLine() and nextInt())
				}

				mylibrary.delContentFromPlaylist(playindex, playTitle);
