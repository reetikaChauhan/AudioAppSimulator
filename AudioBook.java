...
public class AudioBook extends AudioContent {
	...
	public void printInfo() {
		super.printInfo();
		System.out.println(" Author: " + this.getAuthor() + " Narrator by: " + this.getNarrator());
	...
	public void play() {
		String currentchaptertitle = this.getChapterTitles().get(this.currentChapter);
		String currentChapter = this.getChapters().get(this.currentChapter);
	...
	public void printTOC() {
		...
		for (int i = 0; i < this.chapterTitles.size(); i++) {
			index++;
			System.out.println("Chapter"+index + ". " + this.chapterTitles.get(i));
		}
